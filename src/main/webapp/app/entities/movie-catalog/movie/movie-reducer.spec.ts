...
import { IMovie, defaultValue } from 'app/shared/model/movie-catalog/movie.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './movie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_MOVIE actions', async () => {
      const arg = { id: 'bf02c5ba-207f-4d3d-8458-34faab9259e2' };
